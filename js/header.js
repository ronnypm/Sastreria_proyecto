...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const celularInput = document.getElementById("celular"); // Input del número de celular
    ...
    celularInput.parentNode.appendChild(mensajeError); // Insertar debajo del input
    ...
    // Validar número de celular (solo 9 dígitos)
    celularInput.addEventListener("input", function () {
        ...
        // Mostrar mensaje si el número no tiene 9 dígitos
        if (valor.length === 9) {
            mensajeError.style.display = "none"; // Ocultar mensaje si es correcto
        } else {
            mensajeError.style.display = "block"; // Mostrar mensaje si es incorrecto
        }
    });
    ...
    window.agregarFila = function () {
        ...
        let celular = celularInput.value.trim(); // Obtener el número de celular
